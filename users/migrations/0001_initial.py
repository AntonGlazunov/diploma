...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('content', '0013_alter_movie_view_movies'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferences', models.ManyToManyField(to='content.category', verbose_name='предпочтения')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('views', models.ManyToManyField(to='content.movie', verbose_name='просмотры')),
            ],
            options={
                'verbose_name': 'Пользователь',
                'verbose_name_plural': 'Пользователи',
                'permissions': [('set_user', 'Блокировка пользователей')],
            },
            managers=[
